...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Clients pay $50/month (or $41.50/month billed annually at $498/year). You send them a signup link specific to your account. Your first 3 clients per coach are completely free.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Coach plans continue at $50/month (or $498/year). Client plans are the same price. Your credits are applied automatically each billing cycle. Cancel anytime from your account. No contracts, no cancellation fees.",
  },
  {
