...
import { ACCESSIBILITY_LAST_UPDATED } from "../config/business";

export default function Accessibility() {
  return (
    <LegalLayout
      title="Accessibility Statement"
      description="Kaynos is committed to making our website and platform accessible to everyone. Learn about our WCAG 2.1 Level AA commitment."
      path="/accessibility"
      heading="Accessibility Statement"
      effectiveDate={ACCESSIBILITY_LAST_UPDATED}
      effectiveLabel="Last updated"
      lead="Kaynos is committed to making our website and platform accessible to everyone, including people with disabilities."
    >
