...
export default function DataUsePolicy() {
  return (
    <LegalLayout
      ...
      description="Kaynos Data Use Policy: how training videos, coach and student content, and account data are processed, retained, and used on our platform."
      path="/data-use"
      heading="Data Use Policy"
